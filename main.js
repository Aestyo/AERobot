...
client.log(
  `--------------------   Démarrage de GLAD Operating System en cours...   --------------------`,
  'main'
);
...
mongoose.connection.on('connected', () =>
  client.log(`Connexion à la base de donnée établie`, 'main')
);
mongoose.connection.on('disconnected', () =>
  client.log(`Connexion à la base de donnée perdue`, 'main', 1)
);
